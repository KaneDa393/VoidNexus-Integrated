local OrionLib = {Flags = {}, Themes = {Default = {Main = Color3.fromRGB(25, 25, 25), Second = Color3.fromRGB(32, 32, 32), Stroke = Color3.fromRGB(60, 60, 60), Divider = Color3.fromRGB(60, 60, 60), Text = Color3.fromRGB(240, 240, 240), TextDark = Color3.fromRGB(150, 150, 150)}}, SelectedTheme = "Default"}
...
pcall(function()
    ...
    for _, v in ipairs(GUIParent:GetChildren()) do
        if v.Name == Orion.Name and v ~= Orion then pcall(function() v:Destroy() end) end
    end
